  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative z-50 w-full flex items-center justify-center">
        ...
        <div 
          className="relative w-16 h-16 bg-[#0a0e1a] border border-white/10 cursor-pointer rounded-full group will-change-transform z-50 flex items-center justify-center shadow-lg shadow-[0_0_20px_rgba(0,212,255,0.15)] hover:shadow-[0_0_25px_rgba(0,212,255,0.3)] transition-all"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-[#0d1624] border border-white/10 cursor-pointer rounded-full will-change-transform shadow-md shadow-[0_0_15px_rgba(0,0,0,0.5)] flex items-center justify-center hover:bg-[#1a2333] transition-colors"
            style={{
